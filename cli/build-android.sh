...
if [ -z ${MOBIDEX_RELEASE_STORE_PASSWORD+x} ]; then
  ...
  echo "./gradlew clean assembleRelease -PMOBIDEX_RELEASE_KEY_ALIAS=${MOBIDEX_RELEASE_KEY_ALIAS+mobidex} -PMOBIDEX_RELEASE_STORE_FILE=${MOBIDEX_RELEASE_STORE_FILE+../mobidex.keystore} -PMOBIDEX_RELEASE_STORE_PASSWORD= -PMOBIDEX_RELEASE_KEY_PASSWORD= -PMOBIDEX_SIGN=1"
  ./gradlew clean assembleRelease -PMOBIDEX_RELEASE_KEY_ALIAS=${MOBIDEX_RELEASE_KEY_ALIAS+mobidex} -PMOBIDEX_RELEASE_STORE_FILE=${MOBIDEX_RELEASE_STORE_FILE+../../mobidex.keystore} -PMOBIDEX_RELEASE_STORE_PASSWORD=${MOBIDEX_RELEASE_STORE_PASSWORD} -PMOBIDEX_RELEASE_KEY_PASSWORD=${MOBIDEX_RELEASE_STORE_PASSWORD} -PMOBIDEX_SIGN=1;
fi;
