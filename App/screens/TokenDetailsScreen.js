...
class TokenDetailsScreen extends Component {
  ...
  render() {
    let { navigation: { state: { params: { token: { address } }}} } = this.props;
    ...
    return (
      <ScrollView refreshControl={(
        ...
        <View>
          ...
          <Text h1 style={{ textAlign: "center" }}>$21.27</Text>
...
export default connect(state => ({ ...state.wallet, ...state.device.layout }), dispatch => ({ dispatch }))(TokenDetailsScreen);
