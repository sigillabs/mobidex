...
export default class ImportMnemonicScreen extends Component {
  ...
  static getDerivedStateFromProps(props, state) {
    const mnemonic = (props.navigation.getParam('mnemonic') || []).slice();
    const page = props.navigation.getParam('page') || 0;
  ...
  previous() {
    ...
    NavigationService.navigate('ImportMnemonic', { mnemonic, page: page - 1 });
  }
